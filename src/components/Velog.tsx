...
export const Velog = ({ color }: VelogProps) => (
  <svg width="100%" height="100%" viewBox="0 0 192 192" fill="none">
    <rect width="192" height="192" fill={color} rx="24" />
    <path
      ...
      fill={color === Color.Black ? Color.White : Color.Black}
    />
  </svg>
);
